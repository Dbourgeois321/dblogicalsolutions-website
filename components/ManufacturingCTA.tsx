        ...
        <div className="flex flex-col gap-8 rounded-2xl border border-slate-800 bg-slate-900/70 p-8 md:flex-row md:items-center md:justify-between">
          <div className="flex max-w-3xl gap-5">
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-blue-500/10 text-blue-400">
              <Factory size={24} strokeWidth={1.8} />
            </div>
            ...
            <div>
              ...
              <p className="mt-4 leading-7 text-slate-300">
                Tell us where the friction is — inventory, purchasing, material
                flow, production, reporting, or something else. We&apos;ll help
                determine whether the right answer is software, automation,
                process improvement, or a combination.
              </p>
            </div>
          </div>
